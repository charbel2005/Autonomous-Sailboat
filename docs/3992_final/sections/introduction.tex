...
\end{itemize}
Considering stretch goals, excluded from scope are solar charging, full blue-water endurance testing, different sets of environmental sensors, and machine-learning-based control. At Demo Day, the vessel will demonstrate autonomous navigation between a series of waypoints on open water (This will be done before hand and displayed using video).
