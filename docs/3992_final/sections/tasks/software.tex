...
The path planning subsystem computes a route between the current position and the next waypoint, accounting for wind direction and the no-sail zone ($\pm45°$ into the wind).
